...
# Define 4 different palettes (adjusted ARGB format)
palettes = [
    [  # Palette for map 1
    ...
    (255, 0, 0, 148),      # 01 - A:FF R:00 G:00 B:94 - Dark Blue
    (255, 0, 224, 0),      # 02 - A:FF R:00 G:E0 B:00 - Green
    (255, 162, 0, 217),    # 03 - A:FF R:A2 G:00 B:D9 - Purple
    (255, 224, 162, 148),  # 04 - A:FF R:E0 G:A2 B:94 - Flesh
    (255, 162, 0, 217),    # 05 - A:FF R:A2 G:00 B:D9 - Purple
    (255, 224, 0, 0),      # 06 - A:FF R:E0 G:00 B:00 - Red
    (255, 133, 133, 148),  # 07 - A:FF R:85 G:85 B:94 - Grey
    (255, 224, 224, 0),    # 08 - A:FF R:E0 G:E0 B:00 - Yellow
    (255, 162, 133, 0),    # 09 - A:FF R:A2 G:85 B:00 - Gold
    (255, 224, 133, 0),    # 10 - A:FF R:E0 G:85 B:00 - Orange
    (255, 224, 0, 148),    # 11 - A:FF R:E0 G:00 B:94 - Pink
    (255, 0, 0, 217),      # 12 - A:FF R:00 G:00 B:D9 - Blue
    (255, 62, 195, 217),   # 13 - A:FF R:3E G:C3 B:D9 - Aqua
    ...
    [  # Palette for map 3
        (255, 0, 0, 255), (255, 0, 128, 255), (255, 0, 255, 0), (255, 0, 255, 255),
        (255, 128, 0, 128), (255, 128, 0, 255), (255, 255, 255, 255), (255, 0, 0, 0),
        (255, 0, 0, 128), (255, 255, 128, 0), (255, 255, 0, 0), (255, 0, 0, 255),
        (255, 255, 255, 128), (255, 128, 128, 128), (255, 128, 0, 0), (255, 255, 255, 0)
    ],
    [  # Palette for map 4
        (255, 0, 0, 255), (255, 0, 255, 255), (255, 0, 128, 128), (255, 0, 0, 128),
        (255, 128, 128, 128), (255, 255, 128, 0), (255, 255, 255, 128), (255, 255, 0, 128),
        (255, 255, 0, 255), (255, 0, 255, 128), (255, 0, 0, 0), (255, 128, 128, 0),
        (255, 255, 128, 255), (255, 255, 255, 0), (255, 0, 128, 255), (255, 255, 0, 255)
    ]
]
...
def load_tiles():
    ...
    for rom in tile_roms:
        ...
        for i in range(num_tiles):
            ...
            # Use the palette based on map index
            for map_index in range(num_maps):
                color_tile = apply_palette_to_tile(rotated_tile, palettes[map_index])
...
def display_map(maps, all_tiles):
    ...
    for map_index, raw_map_layout in enumerate(maps):
        rotated_map = raw_map_layout  # Correct map orientation
