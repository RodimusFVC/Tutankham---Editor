...
class MapEditor:
    ...
    def setup_ui(self):
        ...
        ttk.Label(left_panel, text="Map Config", font=('Arial', 10, 'bold')).pack(pady=5)
        config_frame = ttk.Frame(left_panel)
        ...
        coord_frame = ttk.Frame(left_panel)
        ...
        selected_frame = ttk.Frame(left_panel)
