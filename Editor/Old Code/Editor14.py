...
def load_palettes_from_rom():
    """Load all 4 map palettes from ROM"""
    # These are FILE offsets in m1.1h, not memory addresses
    palette_offsets = [0x2D1, 0x2E1, 0x2F1, 0x301]  # Map 1-4 (subtract 0xA000)
    palettes = []
    
    rom_data = rom_cache[ROM_CONFIG['high_score_rom']]  # Palettes are in same ROM as high scores
...
palettes = load_palettes_from_rom()  # Load from ROM instead of hardcoded
